...
select distinct titel from buecher where einkaufspreis > (select avg(einkaufspreis) from buecher join )

select distinct titel from buecher where einkaufspreis > (select avg(einkaufspreis) from buecher join buecher_has_sparten, sparten where buecher_has_sparten.sparten_sparten_id = sparten.sparten_id and sparten.sparten_id = 3);
...
select titel from buecher where (verkaufspreis-einkaufspreis) < (select avg(verkaufspreis-einkaufspreis) from buecher where buecher_id != 22);